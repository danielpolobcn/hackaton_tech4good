...
const Footer = () => {
    ...
    return (
        <DivFooter>
            <span className='txtWhite'> 2023 - Barcelona.

                Proyecto clasificado en Hackathon Tech4Good</span>

            <a href="https://github.com/danielpolobcn/hackaton_tech4good" target="_blank" >
                <svg
