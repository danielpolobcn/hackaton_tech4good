...
### Frontend
La interficie de usuario se ha desarrollado con React, utilizando *styled-components* para que mediante una entrada de texto el usuario pueda encontrar el barrio de Barcelona que desa consultar. Tambien se han procesado los datos para visualizarlos en un mapa de la ciudad.
